	...
	<view class="zaiui-home-box" :class="show?'show':''">
		...
		<view style="box-shadow: 5rpx 5rpx 10rpx #CCCCCC;color: white;padding: 25rpx 20rpx;margin: 10rpx 20rpx;margin-top: 30rpx;border-radius: 20rpx;">
			...
			<view style="display: flex;justify-content: space-between;margin: 15rpx 25rpx">
				...
				<view v-if="ispl==1" @tap="toPl3" style="display: flex;flex-direction: column;justify-content: center;align-items: center;">
				...
				<view v-if="isbd==1" @tap="toBeijing" style="display: flex;flex-direction: column;justify-content: center;align-items: center;">
...
<script>
	...
	export default {
		...
		data() {
			return {
				config:"",shopName:"",logo:"",phone:"",wechat:"",qrcode:"",mask: false,is_seller:false,"gonggao":"欢迎您的到来",isbd:0,ispl:0,issfc:0
			}
		},
		props: {
			show: {
		...
		mounted() {
			...
			uni.request({
					...
					success: res => {
						...
						this.issfc = res.data.data.issfc
						this.ispl = res.data.data.ispl
			       },
					fail: () => {},
					complete: () => {}
			});
